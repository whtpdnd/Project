...
<table border="0" style="width:100%; margin:5px;">					
	<tr>
		...
		<td width="630px" align="left" style="padding-left:20px;">가렌에 대한 평가 입니다.</td>
		<td>평점:2</td>
		<td width="200px" align="center" colspan="2">작성자<br>&nbsp;&nbsp;&nbsp;2022.10.15 &nbsp;&nbsp;&nbsp;<br>
		[<a href="javascript:DoReviewModify();">수정</a>] | [<a href="javascript:DoReviewDelete();">삭제</a>]</td>
	</tr>
	<tr>
		<td width="45px" align="center"><img src="../img/garen_1.jpg" width="100%"></td>
		<td width="630px" align="left" style="padding-left:20px;">가렌에 대한 평가 입니다.</td>
	...
	<tr>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a style="color:#ffffff; background-color: #060A41; border-radius:3px 3px 3px 3px; padding: 5px 5px;" href="#">등록</a>
		</td>
	</tr>											
	<tr>
